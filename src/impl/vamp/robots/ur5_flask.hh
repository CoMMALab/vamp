...
{
// FLASK (r = 2) flat system for UR5Flask: configuration z = (q, qdot), dimension 2n.
// Local paths are minimum-acceleration cubics over optimal duration T*; collision blocks
// carry 3n rows (y, yd, ydd) so fkcc fuses sphere FK with position/velocity/torque checks.
struct UR5Flask
{
    static constexpr const char *name = "ur5_flask";
...
q[11] = 1.0 * (q[11] - -0.5);
    ...
    {
        return vamp::planning::flask::optimal_time<UR5Flask>(a_in, b_in);
    }
