...
function(vamp_robot_py_name robot_name out_var)
  ...
  elseif(robot_name STREQUAL "fr3_marker")
    set(${out_var} "fr3marker" PARENT_SCOPE)
  elseif(robot_name STREQUAL "bimanual_iiwa")
    set(${out_var} "bimanualiiwa" PARENT_SCOPE)
  else()
...
if(VAMP_BUILD_PYTHON_BINDINGS)
  ...
  if(NOT VAMP_ROBOT_MODULES)
    ...
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/impl/vamp/robots/fr3_marker.hh")
      list(APPEND VAMP_ROBOT_MODULES fr3_marker)
      list(APPEND VAMP_ROBOT_STRUCTS FR3Marker)
    endif()

    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/impl/vamp/robots/bimanual_iiwa.hh")
      list(APPEND VAMP_ROBOT_MODULES bimanual_iiwa)
      list(APPEND VAMP_ROBOT_STRUCTS BimanualIiwa)
    endif()
  endif()
